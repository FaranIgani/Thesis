...
players <- c(
  ...
  "Nikola Jokic","OG Anunoby","Kevin Durant","Jayson Tatum","Anthony Edwards",
  "De'Aaron Fox","Jamal Murray","Damian Lillard","Kyrie Irving","Trae Young",
  "DeMar DeRozan","Jalen Brunson","Tyler Herro","Luka Doncic",
  "James Harden","Zach LaVine","Cade Cunningham",
  "Karl-Anthony Towns","Austin Reaves","LeBron James","Domantas Sabonis",
  "Paolo Banchero","Bam Adebayo","Jaylen Brown",
  "Giannis Antetokounmpo","Derrick White","Tyrese Haliburton","Anthony Davis",
  "Victor Wembanyama","Rudy Gobert","Jalen Green","Jalen Williams",
  "Stephen Curry","LaMelo Ball","Donovan Mitchell","Ja Morant",

  # remaining added players
  "P.J. Washington","Jaden McDaniels","Dillon Brooks",
  "Miles Bridges","Malik Monk","Jrue Holiday","Myles Turner", 
  "Jordan Poole","Kristaps Porzingis",
  "Payton Pritchard","Aaron Gordon","Chris Paul","Al Horford","Naz Reid",
  "Chet Holmgren","Klay Thompson"
)
...
```{r}
readr::write_csv(full_1_57_dperf, "full_1_57_dperf.csv")
```
